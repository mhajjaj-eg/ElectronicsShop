...
namespace ElectronicsShop.Web.Models
{
    public class ProductRowViewModel
    {
        ...
        public ProductRowViewModel(Product product, string culture)
        {
            ...
            TypeName = (culture == "ar-EG") ? product.ProductCategory.TypeNameAr : product.ProductCategory.TypeNameEn;
    ...
    public class ProductCategoryViewModel
    {
        ...
        public string Name { get; set; }
        public ProductCategoryViewModel(ProductCategory type, string culture)
        {
